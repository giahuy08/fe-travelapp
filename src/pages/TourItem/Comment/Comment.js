...
function Comment(props) {
  ...
  return (
    <>
      ...
      {/* {listcomment.length === 0 && <span>Chưa có đánh giá nào</span>} */}
          ...
          <div className="comment-card">
            <div className="comment-card__header">
              ...
              <div className="comment-card__date">
                <div className="comment-card__date-label">Ngày</div>
                {/* {console.log(item.updateAt)} */}
                {/* <div className="comment-card__date-info">{(new Date(item.updatedAt + 'Z')).toLocaleString({ timeZone: "Asia/Calcutta"})}</div> */}
                <div className="comment-card__date-info">16/11/2021</div>
            ...
            <div className="comment-card__body">
              ...
              <div className="comment-card__body-content">Bài đăng tốt</div>
