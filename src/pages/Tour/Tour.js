...
function Tour() {
  ...
  let defaultUrl =
    "http://localhost:5000/tour/getAllTour?skip=" + page + "&limit=6";
  ...
  return (
    <div className="tours__container">
      ...
      <h3 className="h3-detail">
        ...
        trong thời gian này. Sức khỏe và sự an toàn của cộng đồng luôn được đặt
        hàng đầu. Vì vậy, vui lòng làm theo chỉ thị của chính phủ bởi điều đó
        thực sự cần thiết.
      </h3>
        ...
        <div className="card">
          <div className="cards__container_tour">
            ...
            <div>
              ...
              <button class="tiktok" onClick={search}>
                Tìm
              </button>
            </div>
